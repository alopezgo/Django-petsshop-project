...
class Producto(models.Model):
    ...
    descripcion = models.CharField(max_length=500, verbose_name='Descripcion Producto')
    imagen = models.ImageField(upload_to='static/images/upload',  default= 'static/images/bolsarecoge.jpg')
